            ...
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div className="mt-4 mb-8 relative">
                    ...
                    <div className="inline-block relative w-full">
                        <select name="principal" ref={register({required: true})} className={`${errors.principal ? 'border-red-600' : 'focus:shadow-outline'} block appearance-none w-full text-gray-700 bg-white border border-gray-400 hover:border-gray-500 p-4 pr-8 rounded shadow leading-tight focus:outline-none`}>
                ...
                <div className="mb-8 relative">
                    ...
                    <input name="deadline" ref={register({ required: true })} type="date" placeholder="Username" className={`${errors.deadline ? 'border-red-600' : 'focus:shadow-outline'} w-full p-4 focus:outline-none shadow appearance-none border rounded text-gray-700 leading-tight`} />
                ...
                <div className="mb-8">
                    ...
                    <input name="creator" defaultValue='David' type="text" disabled className="cursor-not-allowed shadow appearance-none border rounded w-full p-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
